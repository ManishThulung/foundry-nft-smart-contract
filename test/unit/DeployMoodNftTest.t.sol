...
contract DeployMoodNftTest is Test {
    ...
    function testConvertToBase64() public view {
        ...
        string memory actualOutput = deployer.saveToImgUri(svg);

        assert(
            keccak256(abi.encodePacked(expectedOutcome)) ==
                keccak256(abi.encodePacked(actualOutput))
        );
    }
}
